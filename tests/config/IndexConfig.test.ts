...
describe('IndexConfig', () => {
  let configManager: InstanceType<typeof IndexConfigManager>;
  ...
  describe('Default Configuration Values', () => {
    it('should have all required performance configuration values', () => {
      ...
      expect(config.performance.defaultVerbSearchLimit).toBe(20);
  ...
  describe('Configuration Persistence', () => {
    it('should save and load configuration', async () => {
      ...
      const newManager = new IndexConfigManager();
