...
describe('PersonaSubmitter', () => {
  let submitter: InstanceType<typeof PersonaSubmitter>;
  ...
  beforeEach(() => {
    ...
    container.register('PersonaSubmitter', () => new PersonaSubmitter());
    submitter = container.resolve('PersonaSubmitter');
  });
