...
entries:
  - id: "entry-1"
    ...
    content: "Performance test entry"`;
      ...
      // Increased from 500ms to 2000ms to account for Windows CI runner variability
      // Windows Node 22.x observed at 1287ms on GitHub Actions (PR #34)
  ...
  description: "Memory with mixed valid and invalid triggers for performance testing"
...
entries: []`;
    ...
    it('should handle memory save/load cycle with many triggers efficiently', async () => {
      ...
      // Increased from 200ms to 300ms to account for slower Windows I/O on CI runners
