...
describe('BaseElement', () => {
  describe('constructor', () => {
    it('should initialize with default values', () => {
      ...
      expect(element.metadata.name).toBe('Untitled Persona');  // MetadataService sets type-specific default
  ...
  describe('validate', () => {
    ...
    it('should provide suggestions', () => {
      ...
      // Author is now set by MetadataService, so no suggestion needed
    });
  });
