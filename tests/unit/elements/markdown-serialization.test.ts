...
describe('Markdown Serialization', () => {
  ...
  describe('Edge Cases', () => {
    it('should handle empty arrays in metadata', () => {
      ...
      // Empty triggers array is normalized to undefined (not serialized)
      // Empty content_flags is preserved as empty array (required field)
    ...
    it('should handle undefined and null values', () => {
      ...
      // Undefined/null should be handled by MetadataService
      expect(frontmatter.name).toBe('Test');
      expect(frontmatter.description).toBe(''); // IElementMetadata sets default
      expect(frontmatter.author).toBeDefined(); // MetadataService sets default author (anon ID)
    });
  ...
  describe('Backward Compatibility', () => {
    ...
    it('should deserialize from JSON format', () => {
      ...
      const restored = new Skill({}, '', metadataService);
