...
describe('Memory Timestamp Handling', () => {
  ...
  describe('getStats with various timestamp formats', () => {
    ...
    it('should handle invalid date strings gracefully', async () => {
      ...
      const entries = (memory as any).entries;
      const entriesArray = Array.from(entries.values()) as MemoryEntry[];

      // Set one entry with invalid timestamp
      entriesArray[0].timestamp = 'invalid-date-string' as any;
    ...
    it('should reject timestamps outside reasonable range', async () => {
      ...
      entriesArray[0].timestamp = '1969-12-31T23:59:59Z' as any; // Before epoch
      entriesArray[1].timestamp = '2200-01-01T00:00:00Z' as any; // Far future
    ...
    it('should handle multiple entries with mixed timestamp validity', async () => {
      ...
      entriesArray[1].timestamp = 'not-a-date' as any;
      entriesArray[2].timestamp = '2025-09-23T10:00:00Z' as any;
  ...
  describe('Auto-repair on read operations', () => {
    it('should auto-repair string timestamps when accessing content getter', async () => {
      ...
      const entries = (memory as any).entries;
      const entriesArray = Array.from(entries.values()) as MemoryEntry[];
      entriesArray[0].timestamp = '2025-09-22T10:00:00Z' as any;
      entriesArray[1].timestamp = '2025-09-23T10:00:00Z' as any;
    ...
    it('should auto-repair during search operations', async () => {
      ...
      entriesArray[0].timestamp = '2025-09-22T10:00:00Z' as any;
      entriesArray[1].timestamp = '2025-09-23T10:00:00Z' as any;
      entriesArray[2].timestamp = '2025-09-24T10:00:00Z' as any;
