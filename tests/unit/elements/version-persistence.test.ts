...
import { createTestMetadataService, createTestFileOperationsService } from '../../helpers/di-mocks.js';
...
describe('Version Persistence', () => {
  ...
  beforeEach(async () => {
    ...
    templateManager = container.resolve<TemplateManager>('TemplateManager');
