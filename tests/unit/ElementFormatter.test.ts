...
describe('ElementFormatter', () => {
  ...
  beforeEach(async () => {
    ...
    formatter = new ElementFormatter({}, fileOperations);
  });
...
No frontmatter here, just content.`;
  ...
  describe('options', () => {
    it('should format in place when inPlace option is true', async () => {
      const formatter = new ElementFormatter({ inPlace: true, backup: true }, fileOperations);
    ...
    it('should use custom output directory when specified', async () => {
      ...
      const formatter = new ElementFormatter({ outputDir }, fileOperations);
    ...
    it('should skip validation when validate option is false', async () => {
      const formatter = new ElementFormatter({ validate: false }, fileOperations);
  ...
  describe('error handling', () => {
    ...
    it('should handle YAML parse errors gracefully', async () => {
      const formatter = new ElementFormatter({ validate: true }, fileOperations);
    ...
    it('should handle file size limit exceeded', async () => {
      const formatter = new ElementFormatter({ maxFileSize: 10 }, fileOperations); // 10 bytes max
