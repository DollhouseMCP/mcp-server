...
const CONTRACT_ROUTES = [
  ...
  'GET /api/v1/me/integrations/descriptors',
  'POST /api/v1/me/integrations/descriptors',
  ...
  'GET /api/v1/me/integrations/:provider',
  'POST /api/v1/me/integrations/:provider/connect',
  'GET /api/v1/me/integrations/:provider/callback',
  'DELETE /api/v1/me/integrations/:provider',
  'GET /api/v1/me/logs',
  ...
  'DELETE /api/v1/admin/accounts/users/:user_id',
  ...
  'GET /api/v1/admin/accounts/users/:user_id/identities',
  'POST /api/v1/admin/accounts/users/:user_id/identities/link',
  'POST /api/v1/admin/accounts/users/:user_id/identities/unlink',
