...
// Type definitions for mocks - using Partial<PortfolioHandler> to avoid interface mismatch
type MockServer = Partial<PortfolioHandler> & {
...
describe('PortfolioTools', () => {
  ...
  describe('Tool Structure', () => {
    it('should return all 6 portfolio tools', () => {
      const tools = getPortfolioTools(mockServer as unknown as PortfolioHandler);
