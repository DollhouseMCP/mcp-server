  ...
  describe('shouldSuppress', () => {
    ...
    describe('wildcard patterns', () => {
      ...
      it('should match test file patterns', () => {
        expect(shouldSuppress('OWASP-A01-001', 'tests/unit/TokenManager.test.ts')).toBe(true);
        expect(shouldSuppress('CWE-89-001', 'tests/security/sql-injection.test.ts')).toBe(true);
      ...
      it('should handle * rule (suppress all)', () => {
        expect(shouldSuppress('ANY-RULE', 'tests/example.test.ts')).toBe(true);
