...
describe('Element Installation Priority Integration Tests', () => {
  ...
  beforeEach(async () => {
    ...
    const portfolioIndexManager = new PortfolioIndexManager(indexConfigManager, portfolioManager, fileOperations);
    const githubIndexer = new GitHubPortfolioIndexer(githubClient, portfolioManager);
    const performanceMonitor = new PerformanceMonitor();

    // Initialize unified index manager
    unifiedIndexManager = new UnifiedIndexManager({
