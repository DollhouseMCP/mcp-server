...
describe('/me/integrations/descriptors', () => {
  ...
  it('connects a static credential without reflecting the secret, disconnects, and cleans up', async () => {
    ...
    const disconnected = await world.clients.userA.delete(`/api/v1/me/integrations/${provider}`);
