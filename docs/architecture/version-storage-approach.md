...
### For Existing Code
1. Prefer `element.version` whenever you touch existing code.
2. Maintain synchronization until migration completes.
3. Add comments explaining the dual-storage pattern.
