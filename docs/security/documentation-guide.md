...
```
/docs/security/
├── architecture.md          # High-level security architecture
├── measures.md              # Public-facing security features
├── documentation-guide.md   # This guide (public vs private split)
├── testing.md               # Security testing infrastructure
├── testing-quick-start.md   # Developer quick checks
└── security-checklist.md    # (Optional) Developer checklist [if present]
```
...
├── README.md                # Access control & onboarding
├── vulnerabilities/         # Detailed write-ups, PoC code, CVSS scoring
├── incidents/               # Incident response reports
├── audits/                  # Full audit results & penetration tests
└── research/                # Threat models, red-team exercises
```
