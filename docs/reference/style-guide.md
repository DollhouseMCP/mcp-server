...
- Include leading `./` for relative paths in documentation (e.g., `./docs/contributing.md` for the Contributor Reference)
...
- [Element system architecture](../developer-guide/element-development.md) - Overview of element types and structure
- [Portfolio management](../guides/portfolio-setup-guide.md) - Setting up your local portfolio

### Next Steps
After completing this guide:
- [Create your first element](../guides/getting-started.md) - Hands-on tutorial
- [Advanced element composition](../guides/roundtrip-workflow-user-guide.md#advanced-workflows) - Combining multiple elements
- [Element best practices](../reference/element-types.md) - Tips for effective elements

### Troubleshooting
If you encounter issues:
- [Common errors](../guides/troubleshooting.md#element-format-issues) - Solutions for frequent problems
...
- [Element file format spec](../developer-guide/element-development.md) - File format details
...
- [Development Workflow](../developer-guide/workflow.md) - Session and contribution workflow
- [Manual Element Construction](../developer-guide/element-development.md) - Developer guide for manual element creation
