...
```yaml
name: session-2025-10-08-morning-doc-updates
description: Session work on refreshing CLAUDE.md and adding new contributor guides
version: 1.0.0
retention: permanent
tags:
  - session-notes
...
entries:
  - timestamp: 2025-10-08T09:00:00Z
    ...
    content: |
      ...
      - Created docs/agent/development/SESSION_MANAGEMENT.md
...
- Follow the [Style Guide](../reference/style-guide.md) for content style
...
- [Style Guide](../reference/style-guide.md) - How to write element content
- [Conventions](../reference/conventions.md) - Naming standards
- [Session Management Guide](../archive/session-history/unsorted/SESSION_MANAGEMENT.md) - Session workflow
- [Element Development Guide](element-development.md) - Element system architecture
